//I changed some parts in the code, now when we run the program the system will ask the user to enter 1 or 2,
//If the user enter 1 then the system will ask the user to enter the replacement rule , then the system will return the cipher text, analysis, and the plain text.
//If the user enter 2 then the system will close the program.
//Also i checked the replacement format in order to be sure that the user will enter the Cipher Text Char in upper case and the Plain Text Char in lower case.
        ...
        int[] letter_Counter = Analysis(cipher);
            ...
            if (choose.equals("1")) {
               ...
               for (int i = 0; i < split.length; i++) {
                 ...
                 if (Character.isLowerCase(beginning) || Character.isUpperCase(end)) {
                     System.out.println("Invalid replacement rule");
                       System.exit(0);
                        }else{
                        System.out.println("\ncipher text:"+"\n"+ cipher+"\n");
