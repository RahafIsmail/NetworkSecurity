//I checked if the replacement rule has the correct format, the cipher text should be in upper case and the plain text should be in lower case.
import java.io.File;
        ...
        System.out.println("\n");
            ...
            if (choose.equals("1")) {
               ...
               for (int i = 0; i < split.length; i++) {
                 ...
                 //Check if the replacement rule has the correct format
