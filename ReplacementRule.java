//I have done the replacement rule. 
//When the user enters 1, the system will ask the user to enter the replacement rule and then return the plain text to the user.
import java.io.File;
        ...
        System.out.println("\n");
            ...
            if (choose.equals("1")) {
               ...
               for (int i = 0; i < split.length; i++) {
                 ...
                 cipher = cipher.toUpperCase().replace(beginning, end);
}
